...
async function getDashboardData() {
  ...
  const echeances = [
    { titre: "Révision du loyer", dateISO: "2026-07-01", type: "loyer" as const },
    { titre: "Renouvellement assurance", dateISO: "2026-09-15", type: "assurance" as const },
    { titre: "Déclaration fiscale", dateISO: "2026-05-20", type: "fiscal" as const },
  ]
...
export default async function DashboardPage() {
  ...
  const now = new Date()
  const dateAujourd = now.toLocaleDateString("fr-FR", {
    weekday: "long",
    day: "numeric",
    month: "long",
  })
